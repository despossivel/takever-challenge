...
class SMTP {
    ...
    constructor() {
        this.TRANSPORTER = {
            host: process.env.SMTP_HOST ? process.env.SMTP_HOST : 'mail.takever.com.br',
            port: process.env.SMTP_PORT ? process.env.SMTP_PORT : 465,
            secure: process.env.SMTP_SECURE ? process.env.SMTP_SECURE : true,
            auth: {
                user: process.env.SMTP_USER ? process.env.SMTP_USER : 'contato@takever.com.brr',
    ...
    async send(to = 'mattbmoller@gmail.com',
        ...
        return await transporter.sendMail({
            from: process.env.SMTP_FROM ? process.env.SMTP_FROM : `"Teakever" <contato@takever.com.br>`,
            to,
            subject,
            text,
            html
